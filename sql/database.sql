...
--
-- Host: localhost:8889
-- Generation Time: Dec 11, 2018 at 01:09 AM
...
INSERT INTO `LoginInfo` (`Username`, `Password`, `FirstName`, `LastName`, `userID`, `photoURL`)
VALUES
...
INSERT INTO `Posts` (`Post_ID`, `Text`, `timecreated`, `userID`)
VALUES
...
(4, '' My mom says I need to apologize for the Cat puns.She said “they are freaking meowt.'', '' 2017-07-24 04:00:00 '',
 1),
...
(15,
 '' I’ve Told Carol for the past week that the red light is offensive for this good religious community.She has FLAGRANTLY and Repeatedly ignored my comments out of concern and I have no choice but to file a complaint with her.How dare she bring up memories of that horrible industry that has no business being in this group.I don’t care if it is a ‘holiday tradition for the ancient Semites and brings good luck to the household’,
 I won’t stand it! I have already told Medea to contact Bryson to tell Jordphan that I want to put an injunction on their house.I told Medea to contact Bryson to tell Jordphan that I will not except no for an answer.THEY WILL CONFORM OR THEY WILL LEAVE.'',
 '' 2017-11-29 05:00:00 '', 4),
...
(20, '' Why are things sent by ship called a cargo, but things sent by cars called shipments?'',
 '' 2017-08-21 04:00:00 '', 1),
(21, '' If you get scared half to death twice, do you die?'', '' 2017-09-21 04:00:00 '', 4),
(22, '' Do any of my family members suffer from mental illness? No, they all seem to enjoy it.'',
 '' 2017-09-14 04:00:00 '', 4),
